...
class Dependencies {
    ...
    function inject($app) {
        ...
        $this->container['\App\Controllers\LucesController'] = function($c) use ($app) {
            return new \App\Controllers\LucesController($c->get('logger'), $c->get('db'), $c->get('validator'));
        };
        $this->container['\App\Controllers\CerrojosController'] = function($c) use ($app) {
            return new \App\Controllers\CerrojosController($c->get('logger'), $c->get('db'), $c->get('validator'));
        };
        $this->container['\App\Controllers\VentilacionesController'] = function($c) use ($app) {
            return new \App\Controllers\VentilacionesController($c->get('logger'), $c->get('db'), $c->get('validator'));
        };
